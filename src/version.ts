 ...
 * storage-format migration version — an unrelated concept). It is the
 * `package` version of the dgapp consent_schema config.proto vendored under
 * `consent_schema/`, pinned by `__tests__/schemaVersion.contract.test.ts`;
 * bump the two together. A literal rather than a generated value: this SDK
 * doesn't consume consent-schema's generated types.
 */
