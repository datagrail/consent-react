...
- `GET /save_open?customer=X&dg_customer_id=X&consent_id=Y&config_version=Z&timestamp=T&library_version=V&os_version=O&schema_version=S` — track banner shown
